 ...
 *
 * BASE_CM_PER_PAGE approximates a physical book where 300 pages ~ 18 cm spine height.
 */

export const BASE_CM_PER_PAGE = 0.06;
 ...
 * Falls back to DEFAULT_PAGE_COUNT (200 pages -> 12 cm) when the count is missing.
 */
