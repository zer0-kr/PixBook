...
export const CHARACTER_DEFINITIONS: CharacterDefinition[] = [
  // ==========================================
  // COMMON (30 characters): 0cm to 850cm
  // ==========================================
  {
    name: "쌀알",
  ...
  // ==========================================
  // RARE (20 characters): 900cm to 4500cm
  // ==========================================
  {
    name: "기린",
  ...
  // ==========================================
  // EPIC (8 characters): 5000cm to 9000cm
  // ==========================================
  {
    name: "피사의 사탑",
